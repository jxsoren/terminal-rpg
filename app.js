...
class Player {
 ...
 const player = new Player("", 500, 5467, 0, 0, 5, 3, 0)
...
function makeEnemy(){
 ...
 console.log(smallSpacing)
 let choice = [`Attack the Big Daddy`, `Stand a little too close to the Little Sister that he is gaurding`, `Flee!`, `Check Inventory and player stats.`]
...
function space(){
 ...
 let vendingChoice = ask.keyInSelect(circusOfValues, `What would you like to purchace from the ` + `CIRCUS OF VALUES`.rainbow.bold + `?` + ` You currently have $${player.balance}` )
